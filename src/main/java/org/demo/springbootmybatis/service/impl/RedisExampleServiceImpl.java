...
import org.demo.springbootmybatis.model.User;
...
public class RedisExampleServiceImpl implements RedisExampleService {
    ...
    public void saveList() {
        ...
        listOps.leftPush("list", new User("姓名1", "12", "男", new Date(timestamp)));
        listOps.leftPush("list", new User("姓名2", "13", "女", new Date(timestamp)));
        listOps.leftPush("list", new User("姓名3", "14", "男", new Date(timestamp)));
        listOps.leftPush("list", new User("姓名4", "15", "女", new Date(timestamp)));
    }
